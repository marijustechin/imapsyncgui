...
> **Status: Paused — awaiting manual physical macOS E2E.**
>
> This task is preserved in full while TASK-011 (Windows x64 support) is the
> single active task in `tasks/current.md`. TASK-010 is **not** Complete. After
> TASK-011 completes, restore this task as the active pending manual task.
